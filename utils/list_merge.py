...
class sub_merge():
    def sub_merge(url_list): # 将转换后的所有 Url 链接内容合并转换 YAML or Base64, ，并输出文件，输入订阅列表。
        ...
        content_yaml = sub_convert.convert(content_raw,'content','YAML',{'dup_rm_enabled': True, 'format_name_enabled': True})
...
if __name__ == '__main__':
    sub_merge.geoip_update('https://ghproxy.net/https://raw.githubusercontent.com/Loyalsoldier/geoip/release/Country.mmdb')
